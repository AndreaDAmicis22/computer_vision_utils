...
class AutoAnomaly:
    ...
    def try_load_warmup(self, listello_height_mm: int = 150, listello_width_mm: int = 2800):
        path = Path(f"/opt/aisent/data/dino_states/{listello_height_mm}_{listello_width_mm}")
